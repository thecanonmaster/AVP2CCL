...
type
  ...
  TRezMgrCallback = procedure(strMsg: string) of object;
  ...
  public
    ...
    constructor Create(FS: TFileStream; InfoCallback: TRezMgrCallback;
      ErrorCallback: TRezMgrCallback; strWorkingDir: string; chPathSeparator: Char);
...
constructor TRezMgr.Create(FS: TFileStream; InfoCallback: TRezMgrCallback;
  ErrorCallback: TRezMgrCallback; strWorkingDir: string; chPathSeparator: Char);
begin
  m_Stream := FS;
